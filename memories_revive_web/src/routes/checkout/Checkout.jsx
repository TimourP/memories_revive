...
const Checkout = ({basket}) => {
	...
	const next_step = () => {
		if (step == 1) {
			window.location.href = `https://edu-beerg1.odoo.com/my/orders/${basket.odoo_id}?access_token=${basket.access_token}`
			return;
		}
		setStep(step + 1);
	}
			...
			<section>
				<div className='checkout-container'>
					<div className='checkout-content'>
						...
						{
							step != 1 ? null :
							<p className='secure'>En procéder au payment vous serez redirigé vers notre page de payment sécurisée.</p>
						}
							...
							<span>
								{
									...
									step == 1 ? "Procéder au payment" : null
								}
							</span>
						</div>
					</div>
