			...
			<section className='cart-top'>
				<div className='cart-content'>
					...
					<div className='informations-list'>
						<p><Icon icon="gridicons:notice-outline" />Les articles dans le panier ne sont pas réservés.</p>
						<p><Icon icon="gridicons:notice-outline" />Droit de rétractation de 14 jours pour les produits non personnalisé.*</p>
						<p><Icon icon="gridicons:notice-outline" />Garantie légale 2 ans pour les accessoires.*</p>
						<p><Icon icon="gridicons:notice-outline" />Garantie à vie pour les cadres.*</p>
					</div>
				</div>
				<TotalBasket/>
			</section>
